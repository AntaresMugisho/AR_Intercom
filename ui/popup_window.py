...
class Ui_Popup_win(object):
    def setupUi(self, Popup_win):
        if not Popup_win.objectName():
            Popup_win.setObjectName(u"Popup_win")
        Popup_win.resize(340, 105)
        self.global_frame = QFrame(Popup_win)
...
"}")
        ...
        QMetaObject.connectSlotsByName(Popup_win)
    # setupUi

    def retranslateUi(self, Popup_win):
        Popup_win.setWindowTitle(QCoreApplication.translate("Popup_win", u"AR Notifier", None))
        self.title.setText(QCoreApplication.translate("Popup_win", u"<html><head/><body><p><span style=\" font-size:10pt;\">Nouveau message</span></p></body></html>", None))
        self.sender_name.setText(QCoreApplication.translate("Popup_win", u"<html><head/><body><p>Un message de Antares</p></body></html>", None))
        self.app_name.setText(QCoreApplication.translate("Popup_win", u"<html><head/><body><p><span style=\" font-size:7pt;\">AR Intercom 2</span></p></body></html>", None))
    # retranslateUi

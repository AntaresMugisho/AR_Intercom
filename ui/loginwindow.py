...
class Ui_LoginWindow(object):
    def setupUi(self, LoginWindow):
        ...
        self.central_log = QtWidgets.QWidget(parent=LoginWindow)
        self.central_log.setObjectName("central_log")
        self.log_username = QtWidgets.QLineEdit(parent=self.central_log)
...
"}")
        ...
        self.log_password = QtWidgets.QLineEdit(parent=self.central_log)
...
"}")
        ...
        self.log_password.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.log_password.setObjectName("log_password")
        self.toogle_button = QtWidgets.QPushButton(parent=self.central_log)
        self.toogle_button.setGeometry(QtCore.QRect(578, 248, 24, 24))
        self.toogle_button.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
...
"            border:none;}")
        ...
        self.connect_log = QtWidgets.QPushButton(parent=self.central_log)
...
"}")
        ...
        self.welcome_log = QtWidgets.QLabel(parent=self.central_log)
...
"color: rgb(255, 255, 255);font-size:16px; font-weight:bold; font-family:Roboto ;")
        self.welcome_log.setAlignment(QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        self.welcome_log.setObjectName("welcome_log")
        self.connect_now = QtWidgets.QLabel(parent=self.central_log)
...
"border-radius:10px;")
        self.connect_now.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.connect_now.setObjectName("connect_now")
        self.logo_log = QtWidgets.QLabel(parent=self.central_log)
...
"")
        ...
        self.main_title_log = QtWidgets.QLabel(parent=self.central_log)
        ...
        self.main_title_log.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.main_title_log.setObjectName("main_title_log")
        self.multi_logo_background = QtWidgets.QLabel(parent=self.central_log)
...
"background-image: url(:/icons/icons/multilogo.png);")
        ...
        self.multicolor = QtWidgets.QFrame(parent=self.central_log)
        self.multicolor.setGeometry(QtCore.QRect(0, 85, 291, 351))
        self.multicolor.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.multicolor.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.multicolor.setObjectName("multicolor")
        self.logo_20 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_10 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_4 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_12 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_19 = QtWidgets.QLabel(parent=self.multicolor)
...
"background-color: rgba(249, 161, 97, 180);")
        ...
        self.logo_13 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_6 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_8 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_27 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_25 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_28 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_24 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_16 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_7 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_14 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_23 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_22 = QtWidgets.QLabel(parent=self.multicolor)
...
"background-color: rgba(239, 88, 63, 200);")
        ...
        self.logo_17 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_9 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_18 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_26 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_21 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_15 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_11 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_5 = QtWidgets.QLabel(parent=self.multicolor)
...
"")
        ...
        self.logo_29 = QtWidgets.QLabel(parent=self.multicolor)
        ...
        self.logo_30 = QtWidgets.QLabel(parent=self.multicolor)
...
"background-color: rgba(239, 88, 63, 170);")
        ...
        self.label = QtWidgets.QLabel(parent=self.central_log)
        self.label.setGeometry(QtCore.QRect(630, 420, 51, 16))
        self.label.setStyleSheet("QLabel{\n"
"    color:#C5C5C5;    \n"
"}")
        self.label.setObjectName("label")
        self.name_warning = QtWidgets.QLabel(parent=self.central_log)
...
"font-size:12px;")
        ...
        self.psw_warning = QtWidgets.QLabel(parent=self.central_log)
...
"font-size:12px;")
        ...
        self.log_password.returnPressed.connect(self.connect_log.click) # type: ignore

...
"")
        ...
        self.p_usrer_pict.setStyleSheet(u"QLabel{\n"
"	border-radius:30px;\n"
...
"background-size: 50px;*/")
        self.p_usrer_pict.setScaledContents(True)
        self.p_user_online_toast = QLabel(self.p_user_box)
        self.p_user_online_toast.setObjectName(u"p_user_online_toast")
        self.p_user_online_toast.setGeometry(QRect(52, 50, 16, 16))
        self.p_user_online_toast.setStyleSheet(u"QLabel{\n"
"	border-radius:8px;\n"
"	background-color: #00ff00;\n"
"}")
        self.p_user_online_toast.setFrameShadow(QFrame.Raised)
        self.p_user_status = QLabel(self.p_user_box)
        self.p_user_status.setObjectName(u"p_user_status")
        self.p_user_status.setGeometry(QRect(79, 39, 191, 21))
        font2 = QFont()
        font2.setItalic(True)
        self.p_user_status.setFont(font2)
        self.p_username = QLabel(self.p_user_box)
        self.p_username.setObjectName(u"p_username")
        self.p_username.setGeometry(QRect(80, 20, 191, 21))
        self.p_username.setFont(font)
        self.p_username.setStyleSheet(u"")
...
"	background-color: rgb(101, 102, 103);}")
        ...
        self.contact_image = QFrame(self.active_client_frame)
        self.contact_image.setObjectName(u"contact_image")
        self.contact_image.setMinimumSize(QSize(50, 50))
        self.contact_image.setMaximumSize(QSize(50, 50))
        self.contact_image.setStyleSheet(u"\n"
"background-color: rgb(40, 44, 52);\n"
"")
        self.contact_image.setFrameShape(QFrame.StyledPanel)
        self.contact_image.setFrameShadow(QFrame.Raised)

        self.horizontalLayout_3.addWidget(self.contact_image)
...
"}")
        ...
        self.emoji_scroll_area_9 = QScrollArea(self.tab_recent)
        self.emoji_scroll_area_9.setObjectName(u"emoji_scroll_area_9")
        self.emoji_scroll_area_9.setGeometry(QRect(0, 0, 567, 83))
        self.emoji_scroll_area_9.setStyleSheet(u"border:none;")
        self.emoji_scroll_area_9.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        self.emoji_scroll_area_9.setWidgetResizable(True)
        self.emoji_scroll_area_9.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.scrollAreaWidgetContents_10 = QWidget()
        self.scrollAreaWidgetContents_10.setObjectName(u"scrollAreaWidgetContents_10")
        self.scrollAreaWidgetContents_10.setGeometry(QRect(0, 0, 567, 83))
        self.emoji_grid_layout_9 = QGridLayout(self.scrollAreaWidgetContents_10)
        self.emoji_grid_layout_9.setSpacing(1)
        self.emoji_grid_layout_9.setObjectName(u"emoji_grid_layout_9")
        self.emoji_grid_layout_9.setContentsMargins(0, 0, 0, 0)
        self.emoji_scroll_area_9.setWidget(self.scrollAreaWidgetContents_10)
...
"background-position:right;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.p_user_online_toast.setText("")
        self.p_user_status.setText(QCoreApplication.translate("MainWindow", u"Coding...", None))
        self.p_username.setText(QCoreApplication.translate("MainWindow", u"Antares", None))

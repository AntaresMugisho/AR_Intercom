...
"padding:1px;")
        ...
        self.left_msg_frame_3 = QFrame(self.widget_3)
        self.left_msg_frame_3.setObjectName(u"left_msg_frame_3")
        self.left_msg_frame_3.setMinimumSize(QSize(320, 111))
        self.left_msg_frame_3.setStyleSheet(u"")
        self.left_msg_frame_3.setFrameShape(QFrame.StyledPanel)
        self.left_msg_frame_3.setFrameShadow(QFrame.Raised)
        self.frame_10 = QFrame(self.left_msg_frame_3)
...
"border-radius:4px;")
        ...
        self.frame_11 = QFrame(self.left_msg_frame_3)
...
"border-radius:7px;")
        ...
        self.frame_12 = QFrame(self.left_msg_frame_3)
...
"}")
        ...
        self.horizontalLayout_15.addWidget(self.left_msg_frame_3)
...
"background-position:right;")
        ...
        self.verticalLayout_20.addWidget(self.bg_app)
